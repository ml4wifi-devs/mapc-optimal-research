...
EXEMPLARY_SCENARIOS = [
    residential_scenario(seed=1, n_steps=600, x_apartments=2, y_apartments=2, n_sta_per_ap=4, size=10.0),
    DynamicScenario.from_static_scenarios(
        residential_scenario(seed=2, n_steps=600, x_apartments=2, y_apartments=2, n_sta_per_ap=4, size=20.0),
        residential_scenario(seed=3, n_steps=600, x_apartments=2, y_apartments=2, n_sta_per_ap=4, size=20.0),
