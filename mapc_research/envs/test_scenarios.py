...
RESIDENTIAL_SCENARIOS = [
    ...
    residential_scenario(seed=106, n_steps=9000, x_apartments=3, y_apartments=3, n_sta_per_ap=4, size=10.0),
    residential_scenario(seed=107, n_steps=9000, x_apartments=3, y_apartments=3, n_sta_per_ap=4, size=20.0),
    residential_scenario(seed=108, n_steps=9000, x_apartments=3, y_apartments=3, n_sta_per_ap=4, size=30.0),
